...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r border-white/10 bg-gray-950 px-4 py-6">
      {/* Logo */}
      ...
      {/* WS status at bottom */}
      <div className="mt-auto flex items-center gap-2 rounded-lg border border-white/10 px-3 py-2">
        <Circle
          className={cn(
